...
print(f"Best trial accuracy for Naive Bayes with Char TF-IDF: {study.best_value:.4f}")
...
joblib.dump(final_model, os.path.join(OUTPUT_DIR, 'char_tfidf_naive_bayes_model.joblib'))
